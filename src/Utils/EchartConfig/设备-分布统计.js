       ...
       tooltip: {
         ...
         formatter: function (datas) {
            ...
            let res = ''
              ...
              '<p style="padding-left:0.2rem;margin:0;font-size: .24rem;text-align: left;color: #00F9FC;font-family: "HY55";font-weight:bold;">' +  '正常' + datas[0].value +'</p >' 
              + '<p style="position: absolute;left: 0.3rem;bottom:0.55rem;font-size: .24rem;text-align: left;color: #FAD65F;font-family: "DINBOLD";font-weight: bold;">' +'故障' + datas[1].value + '</p >'
              
            
            return res + bgimg + '</div >'
          },
