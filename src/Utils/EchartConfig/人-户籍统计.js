  ...
  tooltip: {
    ...
    formatter: function (datas) {
        ...
        for (let i = 0, length = datas.length; i < length; i++) {
          ...
          '<p style="padding-left:0.2rem;margin:0;font-size: .24rem;text-align: left;color: #00F9FC;font-family: "HY55";font-weight:bold;">' + datas[i].name + '人数' + '</p >' + '<p style="position: absolute;left: 0.3rem;bottom:0.55rem;font-size: .24rem;text-align: left;color: #00F9FC;font-family: "DINBOLD";font-weight: bold;">' + (val).toLocaleString() + '人' + '</p >'
          + bgimg + '</div >'
        }
        return res
      },
