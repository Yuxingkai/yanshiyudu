    ...
    <div class="gateDetailDialog_content">
      <div class="gateDetailDialog_content_left">
        <div class="doorTab">
          ...
          <!--<el-tab-pane label="大门入口" name="first">大门入口</el-tab-pane>-->
          <!--<el-tab-pane label="大门出口" name="second">大门出口</el-tab-pane>-->
          <!--</el-tabs>-->
        </div>
        <div class="capture">
          <div
...
<script>
import prewarnItem from '../../components/prewarnItem'
      ...
      this.$post(apiNames['地图实时通行'], {
        ...
        if (res.responseStatus.resultCode === 0) {
          ...
          if (this.pagenum <= totalPage) {
            this.asscessPList = this.asscessPList.concat(res.data)
