  ...
  <div class='accessLog'>
      <div class="select">
          ...
          <div class="laberType">
            ...
            <div class="right">
              <el-select v-model="carType" placeholder="请选择" :popper-append-to-body='false'>
                <el-option
          ...
          <div class="laberType special">
           ...
           <div class="btn_box">           
              <span class="btn" @click="reset" style="margin-right: 0.1rem">重置</span>
  ...
  methods: {
    ...
    getFilterAccsss() {
       ...
       this.$post(apiNames['车辆通行记录'],{
         ...
         accessTimeStart: this.time,
         accessTimeEnd: this.time,
         virtualCodes: this.time,
         inOutType: '',
         }).then(res=> { 
    ...
    getAccsssType() {
     ...
     this.$post(apiNames['一人一档开门方式']).then(res=> {
        if (res.responseStatus.resultCode === 0) {  
              // let datas = res.data
              console.log(res)
              // that.accessTypeOptions = res.data
