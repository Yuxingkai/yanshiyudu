<template>
  <div class="mapSiheyuanDialog">
    <div class="header">
      <div>{{ Houses.name }}</div>
      <div><img @click="close" :src="closeImg" alt="" /></div>
    </div>
    <div class="overlook">
      <div class="quanjintu" v-if="Houses.name === '寿比33号'" @click="tabQjt">{{isShowQJT?'关 闭':'全景图'}}</div>
    ...
    <div v-if="isShowQJT" class="panorama">
      <vtour></vtour>
    </div>
    <div class="Info">
      <div class="left">
